...
<div>
        ...
        @foreach($ingredientes as $ingrediente)
            ...
            <form action="{{ route('recetaIngrediente.update', ['id' => $ingrediente->id_ingrediente]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method("PATCH")
                <div class="editor mx-auto w-10/12 flex flex-col text-gray-800 border border-gray-300 p-4 shadow-lg max-w-2xl">
                    ...
                    <div class="form-group">
                        ...
                        <!-- buttons -->
                            ...
                            <div class="form-group">
                                <button class="shadow bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded " >Actualizar</button>
                            </div>
        ...
        @endforeach
            <div class="editor mx-auto w-10/12  text-gray-800 border border-gray-300 p-4 shadow-lg max-w-2xl">
                ...
                <form action="{{ route('recetaIngrediente.create', ['id' => $receta->id_receta]) }}" method="GET" enctype="multipart/form-data">
                    @csrf
                    <button class="shadow bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded mb-1" >Agregar Ingredientes</button>
                </form>

                <form action="{{ route('recetaIngrediente.delete', ['id' => $receta->id_receta]) }}" method="GET" enctype="multipart/form-data">
                    @csrf
                    <button class="shadow bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded mb-1" >Eliminar Ingredientes</button>
                </form>
            </div>
</div>
</x-app-layout>